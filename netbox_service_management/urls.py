...
urlpatterns = (
    ...
    path("service_template_groups/<int:pk>/changelog/", ObjectChangeLogView.as_view(), name="servicetemplategroupcomponent_changelog", kwargs={"model": models.ServiceTemplateGroupComponent}),
