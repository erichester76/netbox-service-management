...
urlpatterns = (
    ...
    path("service_templates/<int:pk>/changelog/", views.ServiceTemplateChangeLogView.as_view(),name="servicetemplate_changelog", kwargs={"model": models.ServiceTemplate}),
    ...
    path("service_template_groups/<int:pk>/changelog/", views.ServiceTemplateGroupChangeLogView.as_view(), name="servicetemplategroup_changelog", kwargs={"model": models.ServiceTemplateGroup}),
    ...
    path("service_template_groups/<int:pk>/changelog/", views.ServiceTemplateGroupComponentChangeLogView.as_view(), name="servicetemplategroupcomponent_changelog", kwargs={"model": models.ServiceTemplateGroupComponent}),
    ...
    path("services/<int:pk>/changelog/", views.ServiceChangeLogView.as_view(), name="service_changelog", kwargs={"model": models.Service}),
