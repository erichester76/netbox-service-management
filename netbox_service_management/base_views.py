...
class BaseListView(generic.ObjectListView,generic.BulkEditViewMixin,generic.BulkDeleteViewMixin):
    ...
    def get_bulk_edit_form(self):
        """
        Override this method in child views to provide a specific bulk edit form.
        """
